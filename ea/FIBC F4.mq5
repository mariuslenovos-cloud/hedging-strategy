//| GENERATED TEST CELL F4 -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-F4-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL F4 -- zero-input build; deltas: UseDailyTrendFilter=false, FirstGateSellMinWinRate=0.55");
