//| GENERATED TEST CELL F1X -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-F1X-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL F1X -- zero-input build; deltas: MinFloatToActivate=40.0, BasketTrailAmount=10.0");
