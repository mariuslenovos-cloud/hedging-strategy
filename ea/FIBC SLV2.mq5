//| GENERATED TEST CELL SLV2 -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-SLV2-2026-07-13"
...
const bool UseFirstEntryGate    = false;  // CELL-LOCKED
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL SLV2 -- zero-input build; deltas: UseFirstEntryGate=false");
