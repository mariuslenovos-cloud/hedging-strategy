//| GENERATED TEST CELL F3 -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-F3-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL F3 -- zero-input build; deltas: FirstGateSellMinWinRate=0.55");
