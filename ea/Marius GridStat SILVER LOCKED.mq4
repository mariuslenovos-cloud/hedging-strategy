...
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//|  Marius GridStat GOLD v1.0 -- BUILD 2026-06-05-O                 |
...
#define EA_BUILD_VERSION "2026-07-12-P-SILVER-LOCKED"
...
const string StatsCSVFile          = "gridstat_setups_silver.csv";  // LOCKED (was input)
...
const int grisk                 = 14;  // LOCKED (was input)
...
const double RiskPctPerTrade       = 2.0;      // target risk per trade as % of balance (gold-equivalent ~4%)  // LOCKED (was input)
...
const double ProfitTargetUSD       = 75.0;   // grid-recovery escape: bail basket at this small profit  // LOCKED (was input)
