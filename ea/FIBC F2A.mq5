//| GENERATED TEST CELL F2A -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-F2A-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL F2A -- zero-input build; deltas: UseDailyTrendFilter=false, ADX_Threshold=15.0");
