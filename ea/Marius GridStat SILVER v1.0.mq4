...
#define EA_BUILD_VERSION "2026-06-05-O"
...
input string StatsCSVFile          = "gridstat_setups_silver.csv";
...
input bool   UseRiskNormalizedLots = true;    // size each trade so 1R = RiskPctPerTrade% of balance (equalizes $ risk across symbols)
