//| GENERATED TEST CELL G4 -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-G4-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL G4 -- zero-input build; deltas: grisk=4");
