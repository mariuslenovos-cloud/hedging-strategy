//| GENERATED TEST CELL XD -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-XD-2026-07-13"
...
const double MinFloatToActivate   = 60.0;  // CELL-LOCKED
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL XD -- zero-input build; deltas: MinFloatToActivate=60.0, BasketTrailAmount=10.0");
