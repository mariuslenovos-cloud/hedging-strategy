//| GENERATED TEST CELL F4A -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-F4A-2026-07-13"
...
const double ADX_Threshold       = 15.0;  // CELL-LOCKED
...
const double FirstGateSellMinWinRate = 0.55; // SELL-only threshold (0 = use FirstGateMinWinRate). Gold longs >> shorts -> set this higher (e.g. 0.65) to cut weak shorts.  // CELL-LOCKED
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL F4A -- zero-input build; deltas: UseDailyTrendFilter=false, FirstGateSellMinWinRate=0.55, ADX_Threshold=15.0");
