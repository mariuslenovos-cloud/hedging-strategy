//| GENERATED TEST CELL ANCH -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-ANCH-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL ANCH -- zero-input build; deltas: MinFloatToActivate=40.0, ScaleAnchorBalance=10000");
