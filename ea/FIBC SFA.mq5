//| GENERATED TEST CELL SFA -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-SFA-2026-07-13"
...
const double ScaleAnchorBalance   = 10000;     // cold-start protection: >0 -> compounding scale counts only balance ABOVE this  // CELL-LOCKED
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL SFA -- zero-input build; deltas: MinFloatToActivate=40.0, UseStagedFloor=true, ScaleAnchorBalance=10000");
