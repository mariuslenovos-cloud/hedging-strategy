//| GENERATED TEST CELL F2 -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-F2-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL F2 -- zero-input build; deltas: UseDailyTrendFilter=false");
