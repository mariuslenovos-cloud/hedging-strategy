//| GENERATED TEST CELL CAP1 -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-CAP1-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL CAP1 -- zero-input build; deltas: MinFloatToActivate=40.0, MaxCompoundScale=1");
