//| GENERATED TEST CELL CAP2 -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-CAP2-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL CAP2 -- zero-input build; deltas: MinFloatToActivate=40.0, MaxCompoundScale=2");
