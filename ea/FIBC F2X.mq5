//| GENERATED TEST CELL F2X -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-F2X-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL F2X -- zero-input build; deltas: UseDailyTrendFilter=false, MinFloatToActivate=40.0, BasketTrailAmount=10.0");
