//| GENERATED TEST CELL XB -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-XB-2026-07-13"
...
const double MinFloatToActivate   = 50.0;  // CELL-LOCKED
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL XB -- zero-input build; deltas: MinFloatToActivate=50.0, BasketTrailAmount=10.0");
