//| GENERATED TEST CELL F1S -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-F1S-2026-07-13"
...
const int SessionStartHour     = 2;  // CELL-LOCKED
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL F1S -- zero-input build; deltas: SessionStartHour=2");
