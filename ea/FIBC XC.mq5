//| GENERATED TEST CELL XC -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-XC-2026-07-13"
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL XC -- zero-input build; deltas: MinFloatToActivate=40.0, BasketTrailAmount=15.0");
