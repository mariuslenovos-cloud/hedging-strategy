//| GENERATED TEST CELL XA -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-XA-2026-07-13"
...
const double MinFloatToActivate   = 30.0;  // CELL-LOCKED
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL XA -- zero-input build; deltas: MinFloatToActivate=30.0, BasketTrailAmount=10.0");
