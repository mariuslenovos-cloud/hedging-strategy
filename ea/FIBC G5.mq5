//| GENERATED TEST CELL G5 -- do not edit; regen via fibc_make_cells.py |
//+------------------------------------------------------------------+
...
#define BUILD "FIBC-CELL-G5-2026-07-13"
...
const int grisk              = 5;        // fib C value (drives auto period/bands)  // CELL-LOCKED
...
int OnInit()
{
   ...
   Print("FIBC TEST CELL G5 -- zero-input build; deltas: grisk=5");
